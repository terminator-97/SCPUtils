...
namespace SCPUtils
{
    ...
    public class SCPSpeak
    {
        public static bool Prefix(Radio __instance, bool b)
        {
            ...
            else if (ScpUtils.StaticInstance.Config.AllowedScps.Contains(player.Role.Type)) return __instance._dissonanceSetup.MimicAs939 = b;
            ...
            else if (player.CheckPermission($"scputils_speak.{player.Role.Type.ToString().ToLower()}")) return __instance._dissonanceSetup.MimicAs939 = b;
            else return false;
        }
    }
}
