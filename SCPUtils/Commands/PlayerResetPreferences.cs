...
namespace SCPUtils.Commands
{
    ...
    public class PlayerResetReset : ICommand
    {
        ...
        public string[] Aliases { get; } = new string[] { "prp" };
        ...
        public bool Execute(ArraySegment<string> arguments, ICommandSender sender, out string response)
        {
            ...
            if (!CommandExtensions.IsAllowed(((CommandSender)sender).SenderId, "scputils.playerresetpreferences") && !((CommandSender)sender).FullPermissions)
            {
